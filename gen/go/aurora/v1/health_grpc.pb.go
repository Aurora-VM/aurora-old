...
const (
	HealthService_Check_FullMethodName = "/aurora.v1.HealthService/Check"
	HealthService_Watch_FullMethodName = "/aurora.v1.HealthService/Watch"
)
...
//
// Health service definition for Aurora Control Plane and Node Agents.
type HealthServiceClient interface {
	// Check returns the immediate status of a target component.
	Check(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error)
	// Watch streams component status updates over a persistent channel.
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aurora.v1.HealthService",
	...
	Metadata: "aurora/v1/health.proto",
}
